...
class _SessionDataState extends State<ScanTiming> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Session Data',style:TextStyle(color: Colors.white)),
...
//     token = box.read('token');
//
//     if (token == null || selectedDeviceId == null) {
//       // Navigate to login if token or device ID is missing
//       _navigateToLogin();
//     } else {
//       _fetchSessionData();
//     }
...
//   Future<void> _fetchSessionData() async {
//     if (token == null || selectedDeviceId == null) {
//       return; // Early exit if token or device ID is null
//     }
//     try {
//       // Format the dates to 'yyyy-MM-dd'
//       String formattedFromDate = DateFormat('yyyy-MM-dd').format(fromDate);
...
//     box.erase(); // Clear the stored values
